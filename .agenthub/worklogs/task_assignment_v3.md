...
|1.2|M2|会话/消息 CRUD 补全：分页历史 + Pin/取消 Pin + 软删除|5h|1.1|§6.3,S23|
|1.3|M2|聊天 UI 完善：三栏布局 + SessionList 排序/置顶/搜索 + MessageBubble 角色样式|8h|1.1|§4.1,§2.2.4|
|1.4|M2|流式细节：thinking 事件展示 + 错误重连 + token 计量条|5h|1.1|S12|
