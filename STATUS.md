...
| 我 | 正在做 | 阻塞？ | 本周完成了 |
|----|--------|--------|-----------|
| **黎** (oldmanpushbike) | UI 日常维护 (feature/misc/daily-housekeeping, 6/10) | 无 | Template v4 (192 模板+favorites) ✅ + CLI streaming 全线 (5 种流式事件 UI+折叠组) ✅ + token 真数据修复 ✅ + diff 面板统一视图 ✅ + Ctrl+B 预览折叠快捷键 ✅ + 帮助弹窗真实内容 ✅ + 导航栏图标对调 ✅ + 搜索框自适应缩放 ✅ + 网页侧栏预览 ✅ + 删除确认弹窗 ✅ + 会话最近消息 ✅ |
