# M-EV01 — DEPRECATED 标记

> **上一版模块名**：eventbus（事件总线）
> **DEPRECATED 时间**：2026-06-03
> **修订依据**：[可行性问题清单_2026-06-03.md](../../../../plan/后续升级计划/MCP接入/可行性问题清单_2026-06-03.md) I-01/I-02/I-03/I-04/I-05
> **处置**：**DEPRECATED（用既有 Redis pub/sub）**
> **真实落点**：MCP 工具调用事件走既有 WS 通道 + Redis pub/sub，不引独立 eventbus
...
**DEPRECATED（用既有 Redis pub/sub）**

真实目标：MCP 工具调用事件走既有 WS 通道 + Redis pub/sub，不引独立 eventbus
