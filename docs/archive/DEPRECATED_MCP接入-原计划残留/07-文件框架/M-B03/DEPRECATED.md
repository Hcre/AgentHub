...
> **处置**：**[RETAIN] 保留作设计参考**
> **真实落点**：映射到 src/backend/app/application/mcp/binding.py（F-008/F-009/F-010/F-011）
...
真实目标：映射到 src/backend/app/application/mcp/binding.py（F-008/F-009/F-010/F-011）
