...
| P1 F1 市场 | 6/2-6/5 | 数据层(4 表/迁移/实体)+ 5 端点 ✅；安装探针 McpInstaller 端口 + LocalMcpInstaller 结构校验(transport 必填项，422 拦截非法配置)✅；真实可达性/进程探针 ⬜（P2/P3 seam） | 52h | 收束 1 + ADR 0004 | 🔄 进行中（F1 齐+19 测试绿） |
